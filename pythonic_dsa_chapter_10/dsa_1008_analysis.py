...
if __name__ == "__main__":
    ...
    sorted_map[10] = 74
    sorted_map[15] = 2
    # print(sorted_map.find_index(11, 0, 5))
    # print(sorted_map.find_ge(11))
    # print(sorted_map.find_ge(22))
    # print(sorted_map.find_le(11))
    # print(sorted_map.find_le(15))
    # print(sorted_map.find_le(0))
