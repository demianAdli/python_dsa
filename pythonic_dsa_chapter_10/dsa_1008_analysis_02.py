...
"""
(This program has been developed in order to apply my
changes to the book's program. So for a better version
you should use dsa_1008_sorted_table.py. However, this file 
is needed for dsa_1011_cost_performance.py)
September 21, 2020
...
Septembr 27
Old version has been deleted and below is a copy of dsa_1008_analysis_03 because
I want to make the find_index() method protected in the mentioned file.
"""
"""
September 21, 2020
I've added the find_le() method.
    ...
    def find_index(self, k, low, high):
        ...
        if high < low:
            ...
            if k == self.table[mid].key:
                ...
                return self.find_index(k, low, mid - 1)     # Note: may return mid
            else:
                return self.find_index(k, mid + 1, high)    # answer is right of mid
...
# ----------------------------- public behaviors -----------------------------
    ...
    def find_ge(self, k):
        ...
        j = self.find_index(k, 0, len(self.table) - 1)  # j s key >= k
        if j < len(self.table):
    ...
    def find_le(self, k):
        ...
        if len(self) == 0:
            return None
        if j == len(self.table) or (j > 0 and self.table[j].key > k):
    ...
    def find_range(self, start, stop):
        ...
        if start is None:
            ...
            j = self.find_index(start, 0, len(self.table) - 1)  # find first result
...
if __name__ == "__main__":
    ...
    print(sorted_map)
    # print(sorted_map.find_index(11, 0, len(sorted_map) - 1))
    print(sorted_map.find_le(28))
    print(sorted_map.find_le(23))
    print(sorted_map.find_le(22))
    print(sorted_map.find_le(7))
    print(sorted_map.find_le(6))
    print(sorted_map.find_le(3))
    print(sorted_map.find_le(2))
    print(sorted_map.find_index(28, 0, len(sorted_map) - 1))
